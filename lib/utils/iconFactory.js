...
function iconFactory(network, iconConfig) {
  var Icon = function Icon(props) {
    var className = props.className,
        ...
        _props$logoBgFillColo = props.logoBgFillColor,
        logoBgFillColor = _props$logoBgFillColo === undefined ? iconConfig.color : _props$logoBgFillColo,
  ...
  Icon.propTypes = {
    ...
    logoBgFillColor: _propTypes2.default.string,
